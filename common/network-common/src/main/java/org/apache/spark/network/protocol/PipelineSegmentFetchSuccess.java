...
/**
 * Response to {@link PipelineSegmentFetchRequest} when a pipeline is opening and a segment of the pipelnie is
 * successfully fetched.
 *
 * @author liweisheng
 * */
public class PipelineSegmentFetchSuccess extends AbstractResponseMessage{
    public final String pipelineManagerId;
    public final Long readViewId;
    public final Long fetchId;

    public PipelineSegmentFetchSuccess(
    ...
    @Override
    public Type type() {
        return Type.PipelineSegmentFetchSuccess;
    }

    @Override
    public ResponseMessage createFailureResponse(String error) {
        return new PipelineSegmentFetchFailure(pipelineManagerId, readViewId, fetchId, error);
    }
    ...
    public boolean equals(Object obj) {
        if(obj == null || !(obj instanceof PipelineSegmentFetchSuccess)){
            return false;
        }

        PipelineSegmentFetchSuccess other = (PipelineSegmentFetchSuccess)obj;
    ...
    public static PipelineSegmentFetchSuccess decode(ByteBuf buf){
        ...
        return new PipelineSegmentFetchSuccess(pipelineManagerId, readViewId, fetchId, managedBuffer);
    }
}
